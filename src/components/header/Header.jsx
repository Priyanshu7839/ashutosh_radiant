...
const Header = () => {
  return (
    <div className="head">
      <div className="first"> Best Website builders in the US</div>
   
      <div className="second">
            <svg className='image' width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
