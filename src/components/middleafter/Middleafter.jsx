...
import './Middleafter.scss'; // Import your CSS or SCSS file for styling
  ...
  return (
    <div className="container_4">
      <div className="left_4">
        <div>4</div>
        <img src={pc1} alt="Image_" />
        <p>CDK</p>
      </div>
      <div className="center_4">
        <p><strong><span>CDK Resposive Builder: </span></strong>An extensive library of widgets and apps, and detailed step-by-step guides</p>
        <div className='disc'>26% off</div>
        <div>
        <p><strong>Main Highlights</strong></p>
        <div className='se_para'>
            <div><span>
                9.9
            </span> Building Responsive</div>
            <div><span>8.9
                </span> Cool</div>
            <div><span>8.9
                </span> Docs</div>
        ...
        <div className="third_para">
            <p className='why'>Why we love it</p>
            <span>
            <svg className="pic"width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<span className='doc'>Documention</span>
            </span>
...
<span className='doc'>Easy Use</span>
            </span>
...
<span className='doc'>Out Of Box</span>
            </span>
        </div>
